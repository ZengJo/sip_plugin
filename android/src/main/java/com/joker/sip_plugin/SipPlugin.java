...
import com.joker.sip_plugin.entity.MSG_TYPE;
import com.joker.sip_plugin.entity.MyBuddy;
import com.joker.sip_plugin.entity.MyCall;
import com.joker.sip_plugin.interfaces.MyAppObserver;
import com.joker.sip_plugin.utils.SoundPoolUtil;
...
public class SipPlugin implements MethodCallHandler
{
  ...
  private static final String CHANNEL = "sip_plugin";
...
//          msg_str += "Registration";
    ...
    public boolean handleMessage(Message msg)
    {
      ...
      switch (what)
      {
        ...
        case MSG_TYPE.CALL_STATE:
          ...
          if (mChannel != null)
          {
            Log.i(TAG, "SipPlugin接收到状态" + callInfo.getStateText());
  ...
  private SipPlugin(final MethodChannel channel, Activity activity)
  {
  ...
  public static void registerWith(Registrar registrar)
  {
    ...
    channel.setMethodCallHandler(new SipPlugin(channel, registrar.activity()));
  }
