...
class SipPlugin {
  ...
  static const MethodChannel _channel = const MethodChannel('sip_plugin');
  ...
  static final pjsip = SipPlugin();

  ///工厂模式
  factory SipPlugin() => _getInstance();

  static SipPlugin get instance => _getInstance();
  static SipPlugin _instance;

  static SipPlugin _getInstance() {
    if (_instance == null) {
      _instance = new SipPlugin._internal();
    }
    return _instance;
  }
